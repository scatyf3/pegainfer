...
- **Qwen3.5 scheduler-level chunked prefill landed (#375)** — per-step prefill token budget slices long prompts across steps, same intent as Qwen3's. See [`models/qwen35/chunked-prefill.md`](../../models/qwen35/chunked-prefill.md).
